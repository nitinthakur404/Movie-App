                ...
                {movieDetails.map((value) => {
                    return (
                        <div className='flex justify-center max-es:hidden relative max-w-screen-xl mx-2  flex-wrap '>
                            <img src={`https://image.tmdb.org/t/p/original/${value.backdrop_path}`} className=' rounded-3xl  max-lg:h-[400px]   block h-[490px] mx-2 max-md:h-96'>
                            </img>


                            <div className='absolute  max-w-screen-xl flex justify-center items-center rounded-3xl w-[99%] h-[490px]  max-md:mx-1  max-lg:h-[400px] bg-gradient-to-t from-slate-600  top-[0%] right-[0%]   max-md:w-[99%] max-sm:w-[98%]   max-md:h-96 max-sm:mx-1'>

                                <div className=' text-yellow-50 flex flex-col justify-center items-baseline relative '  >
                                    <div className=' mt-2'>
