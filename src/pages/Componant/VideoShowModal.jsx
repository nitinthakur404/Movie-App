...
function VideoShowModal({ videoID, openModal, modalHandle }) {
    return (
        ...
        <div>
            <div id="defaultModal" className={`absolute flex ${openModal ? "flex" : "hidden"} transition ease-in-out delay-150 justify-center items-center top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
